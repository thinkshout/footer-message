...
Description:
* This module provides a site footer message, editable on the site-information form and displayed as a block.
* The module replicates the "site footer" feature from Drupal 6.x. for Drupal 7.x sites.
* Note: A migration path for Drupal 6.x sites is forthcoming.
